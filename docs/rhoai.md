...
3) Access the `workbench` named `mar20-chatbot-testbuildci-notebook`.
...
5) In the terminal, run `cd mar20-chatbot-testbuildci` to navigate to your sample app's directory.
